For this program OS library, which can be installed using pip install os. You can shut down, restart, and even set a timer for shutdown or restart with this package.\
